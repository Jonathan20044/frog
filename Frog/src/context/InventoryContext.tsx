...
const initialInventory: InventoryItem[] = [
  ...
  { id: 28, name: 'Cerveza Imperial', category: 'bebida', quantity: 60, unit: 'botellas', minStock: 36 },
  { id: 29, name: 'Cerveza Pilsen', category: 'bebida', quantity: 48, unit: 'botellas', minStock: 24 },
  { id: 30, name: 'Cerveza Bavaria', category: 'bebida', quantity: 36, unit: 'botellas', minStock: 24 },
  { id: 31, name: 'Vino Tinto', category: 'bebida', quantity: 24, unit: 'botellas', minStock: 12 },
  { id: 32, name: 'Vino Blanco', category: 'bebida', quantity: 18, unit: 'botellas', minStock: 12 },
...
export function InventoryProvider({ children }: { children: ReactNode }) {
  ...
  const [nextId, setNextId] = useState(33);
